          ...
          <div class="col-lg-12">
            <form id="contactForm" name="sentMessage" method="post" novalidate>
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <textarea class="form-control" id="message" placeholder="Pertanyaan / Komentar anda *" required data-validation-required-message="Mohon isi form ini" name="pesan"></textarea>
                    <p class="help-block text-danger"></p>
                  </div>
                </div>
