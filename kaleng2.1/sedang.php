    ...
    <div class="jumbotron" style="background-color: #4CAF50">
        ...
        ?>         
          <div class="col-sm-3 col-md-3">
            <div class="thumbnail">
              <img src="img/sedang/materi<?php echo $isi['Id_materi'] ?>.jpg"width="100%" height="100%">
                <div class="caption">
                  <h3><?php echo $isi['judul_materi'] ?></h3>
                  <p><a href="materi<?php echo $isi['Id_materi']+5 ?>.php" class="btn btn-primary" role="button">Lihat</a> </p>
                </div>
            </div>
          </div>
        <?php } ?> 
